...
public class OrderEntity {
	...
	public OrderEntity(long hId, List<String> seat, List<Double> price, double total, String movieName,
			Date bookOnDate, Date showOnDate, String showTime, CustomerEntity customer) {
		super();
		this.hId = hId;
		this.seat = seat;
		this.price = price;
	...
	public OrderEntity(List<String> seat, List<Double> price, double total, String movieName, Date bookOnDate,
			Date showOnDate, String showTime, CustomerEntity customer) {
		super();
		this.seat = seat;
		this.price = price;
		this.total = total;
